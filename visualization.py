...
# Load the files
target = np.load("Outputs_diff/hicedrn_l2_Human1_deno_0.1_test_False/target.npy")
noisy = np.load("Outputs_diff/hicedrn_l2_Human1_deno_0.1_test_False/noisy.npy")
predict = np.load("Outputs_diff/hicedrn_l2_Human1_deno_0.1_test_False/predict.npy")
...
# Show the plots
plt.tight_layout()
plt.savefig("plot_tanh.png", dpi=300)
plt.show()
